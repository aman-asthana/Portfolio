  ...
  return (
    ...
    >
      <motion.div
        ...
        >
        <h2 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-rose-400 to-cyan-400 mb-5">
            Projects & Achivements
        </h2>
        <div className="w-24 h-1 bg-gradient-to-r from-rose-400 to-cyan-400 rounded-full mx-auto mb-8" />
        <p className="text-gray-400 max-w-2xl mx-auto">
          I've been working on my skills and projects and Here is my Projects and Achivements.
        </p>
      </motion.div>
